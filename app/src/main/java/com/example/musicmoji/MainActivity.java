...
public class MainActivity extends AppCompatActivity {
    ...
    private void authenticateSpotify() {
        ...
        builder.setScopes(new String[]{"streaming", "user-read-private", "user-read-email", "user-read-playback-state", "user-modify-playback-state", "user-top-read","user-read-recently-played"});
